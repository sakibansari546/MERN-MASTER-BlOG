...
const BlogPostCard = ({ content, author }) => {
    ...
    return (
        <Link to={`/blog/${id}`} className='boreder-b border-grey w-full flex items-center gap-8 pb-5 mb-4'>
            <div className='w-full'>
                ...
                <div className='flex gap-5 mt-5 mb-10'>
                    ...
                    <span className='ml-3 flex items-center gap-2 text-dark-grey'><i className="fi fi-rr-heart text-xl"></i>{total_likes}</span>
                </div>
            </div>
